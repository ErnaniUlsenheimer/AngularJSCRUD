angular.module('myFormApp', [])
    .controller('ProductController', function ($scope, $http, $location, $window) {
        ...
        function getallData() {
            ...
            //debugger;
            $http.get('http://localhost/angularJSCRUD/Category/GetAllData/')
            ...
            $http.get('http://localhost/angularJSCRUD/Product/GetAllData')
                .success(function (data, status, headers, config) {
        ...
        $scope.getProduct = function (custModel) {
            $http.get('http://localhost/angularJSCRUD/Product/GetbyID/' + custModel.product.Id)
                .success(function (data, status, headers, config) {
                    //debugger;
        ...
        $scope.saveProduct = function () {
            ...
            $http({
                method: 'POST',
                url: 'http://localhost/angularJSCRUD/Product/Insert',
        ...
        $scope.updateProduct = function () {
            ...
            $http({
                method: 'POST',
                url: 'http://localhost/angularJSCRUD/Product/Update',
                data: $scope.custModel.product
            }).success(function (data, status, headers, config) {
                if (data.success === true) {
        ...
        $scope.deleteProduct = function (custModel) {
            ...
            if (IsConf) {
                $http.delete('http://localhost/angularJSCRUD/Product/Delete/' + custModel.product.Id)
                    .success(function (data, status, headers, config) {
                        if (data.success === true) {
