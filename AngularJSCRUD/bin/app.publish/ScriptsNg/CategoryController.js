angular.module('myFormApp', [])
 .controller('CategoryController', function ($scope, $http, $location, $window) {
     ...
     $scope.getCategory = function (custModel) {
         ...
         $http.get('http://localhost/angularJSCRUD/Category/GetbyID/' + custModel.Id)
                .success(function (data, status, headers, config) {
                    //debugger;
        ...
        $scope.saveCategory = function () {
            ...
            $http({
                method: 'POST',
                url: 'http://localhost/angularJSCRUD/Category/Insert',
        ...
        $scope.updateCategory = function () {
            ...
            $http({
                method: 'POST',
                url: 'http://localhost/angularJSCRUD/Category/Update',
                data: $scope.custModel
            }).success(function (data, status, headers, config) {
                if (data.success === true) {
        ...
        $scope.deleteCategory = function (custModel) {
            ...
            if (IsConf) {
                ...
                $http.delete('http://localhost/angularJSCRUD/Category/Delete/' + custModel.Id)
                    .success(function (data, status, headers, config) {
                        if (data.success === true) {
