...
CREATE TABLE `tb_categories` (
  ...
  `codecategory` varchar(64) NOT NULL,
...
CREATE TABLE `tb_customer` (
  ...
  `descustomer` varchar(64) NOT NULL,
  `codecustomer` varchar(64) NOT NULL,
...
INSERT INTO `tb_customer` VALUES (1,'ernani','12345');
...
-- Dump completed on 2022-05-17 17:53:09
